...
def weight_quantization(model, batch_size=1, group_size=4, quant_type="symmetric"):
    ds_config = {
...
def w8a8_quantization(model, batch_size=1, quant_type="symmetric",quantization_bits=8, group_size=4):
    ds_config = {
        "train_micro_batch_size_per_gpu": batch_size,
        "compression": {
            "activation_quantization": {
